...
$('#exportBtn').click(function() {
    ...
    const exportData = {
        ...
        potential: window.fittedResults.potential,
        current: window.fittedResults.current,
        theoretical_current: window.fittedResults.theoretical_current,
        theta: window.fittedResults.theta,
        theta_inv: window.fittedResults.theta_inv,
        tafel_pot: window.fittedResults.tafel_pot,
        tafel_slopes: window.fittedResults.tafel_slopes,
        tafel_theo_pot: window.fittedResults.tafel_theo_pot,
        tafel_theo_slopes: window.fittedResults.tafel_theo_slopes,
        model_type: window.uploadedData.model_type || 'simplified'
    };
